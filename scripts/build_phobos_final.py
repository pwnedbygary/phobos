...
# 1. Reset modified git files to a clean state
...
# 2. Patch ares/ares/ares.hpp with nall/serializer.hpp and serializer type alias
...
# 3. Patch ares/n64/vulkan/parallel-rdp/vulkan/context.hpp directly after vulkan_headers.hpp
...
# 4. Write complete hiro/hiro.hpp
...
# 5. Write complete mia/resource/resource.hpp with ALL system boot ROMs
...
# 6. Write ares/resource/resource.hpp (using forward declarations)
...
subprocess.run(["git", "commit", "-m", "fix: Master resolution script for mia boot ROMs and N64 Vulkan structs"], capture_output=True)

print("\n=======================================================")
print("✅ COMPREHENSIVE PHOBOS BUILD FIX COMPLETED!")
print("=======================================================")
