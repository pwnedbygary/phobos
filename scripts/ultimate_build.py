...
# 5. Write ares/resource/resource.hpp with forward declarations (NO #include <nall/nall.hpp>)
...
# 9. Generate CMakeLists.txt with STRICT INCLUDE PRIORITY ORDER
include_dirs = [
    "${CMAKE_CURRENT_SOURCE_DIR}/nall",  # 1. Nall internal headers (<resource/resource.hpp>)
    "${CMAKE_CURRENT_SOURCE_DIR}/ares",  # 2. Ares core component paths (<cv/cpu/cpu.cpp>)
...
print("✏️ Wrote master CMakeLists.txt with strict include hierarchy.")
...
subprocess.run(["git", "commit", "-m", "fix: Ultimate build script with strict include hierarchy"], capture_output=True)

print("\n=======================================================")
print("✅ ULTIMATE BUILD SYSTEM READY!")
print("=======================================================")
