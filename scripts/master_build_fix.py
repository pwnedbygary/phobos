...
# 2. Write complete hiro/hiro.hpp layout stubs
...
""")
print("✏️ Created complete hiro/hiro.hpp layout stubs.")

# 3. Write ares/resource/resource.hpp with nall::image conversion
...
""")
print("✏️ Created ares/resource/resource.hpp with nall::image operator.")

# 4. Write mia/resource/resource.hpp stub
...
# 5. Collect all header include directories (thirdparty + ares/n64/vulkan subfolders)
extra_includes = set()
...
os.system("git add .")
os.system('git commit -m "fix: Master build fix for vulkan headers, hiro GUI stubs, and DummyImage image operator"')
print("\n=======================================================")
print("✅ ALL-IN-ONE MASTER FIX COMPLETED!")
print("=======================================================")
