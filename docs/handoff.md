...
**RECENT (2026-08-19 → 2026-08-20, code UNCOMMITTED):**
...
## Open Priority Queue
- **Neo Geo MVS/AES — CORE FULLY WORKING (games load/run ~60 FPS, audio, input, and tall-sprite/background rendering all verified on-device). REMAINING: broad game-compat pass via `docs/neo-geo-compatibility.md`. All recent NG fixes UNCOMMITTED. PCEngineCD deferred until NG fully stable.
