...
| 42, 42b, 43, 44, 69 | Perf monitor metrics + presentation | **Deferred QoL, retained (expanded 2026-09-25).** Keep working metrics; overhaul the overlay to feel like **MangoHud** / **GameNative** (clean HUD, not the current janky look). Expose whatever host/game metrics are available for the running system (FPS, frame time, RAM, CPU core, GPU/thermal/driver where attributable — do not fabricate counters). Builds on Tasks 42–44 and 69. [42](implementation-history.md#task-42), [42b](implementation-history.md#task-42b), [43](implementation-history.md#task-43), [44](implementation-history.md#task-44), [69](implementation-history.md#task-69) |
